class AbsencesController < ApplicationController
  ...
  # POST /vacations.xml
  def create
    @absence = Absence.new(absence_parameters)
  ...
  private
  def absence_parameters
    params.require(:absence).permit(:holiday_year_id, :date_from, :date_to, :half_day_from, :half_day_to, :absence_type_id, :description)
  end
end
